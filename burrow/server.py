...
from burrow.protocol import (
    ...
    DESKTOP_SESSION_OPEN, DESKTOP_SESSION_READY, DESKTOP_SESSION_CLOSE,
    DESKTOP_SESSION_LIST, DESKTOP_FRAME_REQUEST, DESKTOP_FRAME,
    DESKTOP_INPUT, DESKTOP_PERMISSION,
